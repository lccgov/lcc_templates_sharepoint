    ...
    <div class="container-fluid">
        ...
        <div class="row">
            <div class="col-md-8">
                ...
                <WebPartPages:WebPartZone runat="server" AllowPersonalization="false" ID="placeholderpageContent" FrameType="TitleBarOnly" Orientation="Vertical"><ZoneTemplate></ZoneTemplate></WebPartPages:WebPartZone>
            </div>
            <div class="col-md-4">
